...
public class MenuItem {
	 ...
	 */
	public MenuItem(String label) { this(label, null, null, null); } // cannot invoke this MenuItem ie. dummy item
	/*
	...
	// MODYFIKACJA
	public MenuItem(String label, Object obj, String target, Object arg) {
		this.label = label;
		this.obj = obj;
		this.target = target;
		this.arg = arg;
